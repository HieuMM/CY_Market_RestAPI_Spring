...
public class Base64ToMultipartFileImpl implements MultipartFile {
     ...
     */
    public Base64ToMultipartFileImpl(String base64, String dataUri) {
    ...
    public Base64ToMultipartFileImpl(String base64, String extension, String contentType) {
        this.fileContent = Base64.getDecoder().decode(base64.getBytes(StandardCharsets.UTF_8));
