...
public class VnPayConfig {
    ...
    public static String vnp_Returnurl = "http://cygroup3.xyz/checkout/success";
    public static String vnp_TmnCode = "AWR7LS6U";
    public static String vnp_HashSecret = "HTHJCSHQGOHDOVITVZRJRBHAJECBBKJC";
